...
<div id="nav"><strong>您的位置:</strong> 账号管理 &gt;&gt; 马甲管理 </div>
<div id="menu">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td class="menu-function"><label>
        <input type="button" name="Submit" value="新增账号" onClick="self.location.href='<?php echo $this->Html->url('/sinas/edit');?>'"/>
        </label>
      </td>
  ...
  <form id="infolist" name="infolist" method="post" action="#" style="margin:0px;">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
      ...
      <tr>
        ...
        <td>
        	<?php echo $this->Html->link('使用', '/sinas/setWork/'.$item['Sina']['id'], array('target' => '_self'))?>
